////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: Sun Mar 22 23:52:04 2015
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQLabel(p,obj1,0);
  pvSetGeometry(p,obj1,162,57,135,30);
  pvSetText(p,obj1,pvtr("This is the Demo"));
  pvSetFont(p,obj1,"Ubuntu",11,0,0,0,0);

  pvQLineEdit(p,amp,0);
  pvSetGeometry(p,amp,291,99,99,30);
  pvSetText(p,amp,pvtr("2"));
  pvSetFont(p,amp,"Ubuntu",11,0,0,0,0);

  pvQLabel(p,obj2,0);
  pvSetGeometry(p,obj2,162,102,99,30);
  pvSetText(p,obj2,pvtr("Amplitude:"));
